module Church = struct
  ...
  let xor' =
    Abs
      ( "x"
      , TVar "a"
      , Abs ("y", TVar "b", App (App (Var "x", App (Var "y", false')), true')) )
  ;;
  ...
  let xnor' =
    Abs
      ( "x"
      , TVar "a"
      , Abs ("y", TVar "b", App (App (Var "x", App (Var "y", true')), false')) )
  ;;
      ...
      , Abs
          ...
          , Abs
              ...
              , Abs
                  ( "x"
                  , TInt
                  , App (App (Var "m", Abs ("f", TArrow (TInt, TInt), Var "x")), Var "x")
                  ) ) ) )
  ;;
      ...
      , Abs
          ...
          , Abs
              ...
              , Abs
                  ( "x"
                  , TInt
                  , App (App (Var "n", Abs ("f", TArrow (TInt, TInt), Var "x")), Var "x")
                  ) ) ) )
  ;;
